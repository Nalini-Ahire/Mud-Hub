...
<head>
    ...
    <title>Mud Works Hub - cart details</title>
...
<!--third child-->
<div class="bg-light">
  <h3 class="text-center">Mud Hub</h3>
  <p class="text-center">Connecting You with Nature's Finest Creations</p>
</div>
    ...
    <div class="row">
        ...
        <table class="table table-bordered text-center">
                ...
                <tbody>";
                   while($row=mysqli_fetch_array($result))
                   {
                       ...
                       while($row_product_price=mysqli_fetch_array($result_products))
                       {
                           ...
                           $price_table=$row_product_price['p_price'];
                           $product_title=$row_product_price['p_title'];
                           $product_img1=$row_product_price['p_img1'];
                ...
                <tr>
                    ...
                    <td><img src="./admin/product_images/<?php echo $product_img1 ?>" alt="" class="cart_image"></td>
                    ...
                    if(isset($_POST['update_cart']))
                    {
                        ...
                        $update_cart="update `cart_details` set quan=$quantities where ip_adr='$get_ip_adr'";
        ...
        <div class="d-flex mb-5">
          ...
          if($result_cnt > 0)
          {
            ...
            <button class='bg-secondary p-3 py-2 border-0'><a href='./user/check_out.php' class=' text-light text-decoration-none'>Check Out</a></button>";
          }
          else
          {
...
function remove_cart_item()
{
  ...
  if(isset($_POST['remove_cart']))
  {
    ...
    {
      echo $remove_id;
      $delete_query="Delete from `cart_details` where p_id=$remove_id";
