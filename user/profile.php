...
<div class="row">
    <div class="col-md-2 ">
        <ul class="navbar-nav bg-secondary text-center" style="height:100vh">
            ...
            <li class="nav-item">
                <a class="nav-link text-light" href="profile.php?edit_acc">Edit Account</a>   <!--getvariable edit_acc-->
            </li>
            <li class="nav-item ">
                <a class="nav-link text-light" href="profile.php?my_order">My orders</a>
            </li>
            <li class="nav-item ">
                <a class="nav-link text-light" href="profile.php?del_acc">Delete Account</a>
            </li>
            <li class="nav-item">
